...
import type UserTotpSecret from '../../../models/user-totp-secret';
import type { AnyObj, Social } from '../../../types';
import type {
...
const userController = {
	...
	async getSocial() {
		...
		try {
			...
			const data = socials.reduce((acc, current) => {
				acc[current.social] = current.link;
				return acc;
			}, {} as AnyObj);
