  ...
  createLinkHtml(link: string, subject: EmailSubject) {
    ...
    switch (subject) {
      ...
      case EmailSubject.VerifyEmail:
        html = `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><title>Confirm Email</title><style> * { margin: 0 auto; padding: 0; } button { background-color: rgb(196, 108, 50); color: rgb(66, 12, 0); font-size: large; font-weight: bolder; border: none; padding: 16px 24px; border-radius: 10px; cursor: pointer; } .logo { max-height: 60px; padding-bottom: 4px; } .icon { max-height: 240px; } .container-wrapper { min-height: 100vh; background-image: url('https://i.imgur.com/x5V8Wfe.png'); background-color: rgb(139, 57, 34); color: black; padding: 16px 48px; text-align: center; } .container { background-color: rgb(231, 207, 192); color: black; border-radius: 24px; padding: 24px; } .wrapper { max-width: 600px; padding: 0 24px; } .wrapper p { text-align: justify; margin: 12px 0; padding: 0 24px 12px; } .copyright { color: rgb(231, 207, 192); margin-top: 16px; }</style></head><body class="container-wrapper"><table align="center"><thead><tr><td><img src="https://i.imgur.com/vAvmoSm.png" alt="Logo" class="logo" /></td></tr></thead><tbody><tr><td class="container"><table><thead><tr><td><img src="https://i.imgur.com/vAvmoSm.png" alt="email" class="icon" /></td></tr></thead><tbody><tr><td><table class="wrapper"><thead><tr><td><h1>Verify Email</h1></td></tr></thead><tbody><tr><td><p> To complete you registration precess please click this button confirm you email address!</p></td></tr><tr><td><a href="${link}" target="_blank"><button style="cursor: pointer;">Verify email</button></a></td></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table></td></tr><tr><td><p class="copyright">© 2025 Blogaer. All Rights Reserved.</p></td></tr></tbody></table></body></html>`;
        break;
      default:
        html = '';
    }
